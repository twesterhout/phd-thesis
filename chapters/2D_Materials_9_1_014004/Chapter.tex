...
}{AB-stacked bilayer graphene Coulomb matrix elements. Orange circles depict cRPA results. The blue line is obtained by fitting Eq.~\eqref{eq:mat22:image-charge-model} to the cRPA data. In green we show the locally-screened Coulomb interaction (i.e. the first term in Eq.~\eqref{eq:mat22:image-charge-model}). Pink diamonds show fully-screened Coulomb interaction $W(r,r'=\mathrm{center},\omega=0)$.%
}{fig:mat22:Coulomb}

...
% \textbf{Data availability:} Numerical data are stored in repository~\cite{zenodo-data}, and the scripts used to generate them are stored in repositories ~\cite{SA-code-1, zenodo-code}.
% \vskip 10pt
% \textbf{Code availability:} Exact diagonalization has been performed using the SpinED package~\cite{SpinED}.
% We have used the lattice-symmetries package~\cite{lattice-symmetries} for all other manipulations with many-body wave functions.
% The Simulated Annealing and greedy algorithms are implemented in the ising-glass-annealer package~\cite{SA-code-2}.
% All other scripts that have been used to produce and process the data can be found in~\cite{SA-code-1}.
% \vskip 10pt
% \textbf{Acknowledgements:} The work is supported by European Research Council via Synergy Grant 854843 - FASTCORR.
% We would like to thank Giuseppe Carleo, Jannes Nys, and Evgeny Stepanov for useful discussions.
% We thank SURF~\cite{SURF} for the support in using the National Supercomputer Snellius.
% \vskip 10pt
% \textbf{Author contributions:} Tom Westerhout suggested the concept of auxiliary sign Ising models, implemented the codes, and ran the simulations.
% Andrey Bagrov participated in all project discussions, framed the project and wrote the manuscript.
% Mikhail Katsnelson provided general supervision of the research.
% All authors helped fine tune the manuscript.
% \vskip 10pt
...
% \section*{References}
% \bibitem{quantum_phase} Ming-Cheng Chen et al., Ruling out real-valued standard formalism of quantum theory, Phys. Rev. Lett. 128, 040403 (2022)
% \bibitem{interference}Zbigniew Ficek and Stuart Swain, Quantum interference and coherence: theory and experiments, Springer Science \& Business Media, 2005
% \bibitem{localization}Philip W. Anderson, Absence of Diffusion in Certain Random Lattices, 
% Phys. Rev. 109, 1492 (1958)
% \bibitem{coherence}Alexander Streltsov, Gerardo Adesso, and Martin B. Plenio, Colloquium: Quantum coherence as a resource, Rev. Mod. Phys. 89, 041003 (2017)
% \bibitem{Aharonov-Bohm} Yakir Aharonov and David Bohm, Significance of electromagnetic potentials in the quantum theory, Phys. Rev. 115, 485 (1959)
% \bibitem{olariu} S. Olariu and I. Iovitzu Popescu, The quantum effects of electromagnetic fluxes, Rev. Mod. Phys. 57, 339 (1985)
% \bibitem{Kaplis}Nikolaos Kaplis, Frank Kr\"uger, and Jan Zaanen, Entanglement entropies and fermion signs of critical metals,
% Phys. Rev. B 95, 155102 (2017)
% \bibitem{Grover}Tarun Grover and Matthew P. A. Fisher, Entanglement and the sign structure of quantum states, Phys. Rev. A 92, 042308 (2015)
% \bibitem{fractals}Frank Kr\"uger and Jan Zaanen, Fermionic quantum criticality and the fractal nodal surface, Phys. Rev. B 78, 035104 (2008)
% \bibitem{frustrations}Patrik Henelius and Anders W. Sandvik, Sign problem in Monte Carlo simulations of frustrated quantum spin systems,
% Phys. Rev. B 62, 1102 (2000)
% \bibitem{finite_density}Steven R. White, Douglas J. Scalapino, Robert L. Sugar, E. Y. Loh, James E. Gubernatis, and Richard T. Scalettar, Numerical study of the two-dimensional Hubbard model,
% Phys. Rev. B 40, 506 (1989)
% \bibitem{sign_problem}Hans De Raedt and Ad Lagendijk, Monte Carlo simulation of quantum statistical lattice models, Physics Reports
% 127, 233 (1985)
% \bibitem{vmc}Sandro Sorella, Wave function optimization in the variational Monte Carlo method,
% Phys. Rev. B 71, 241103(R) (2005)
% \bibitem{tensor_networks}Roman Orus, A practical introduction to tensor networks: Matrix product states and projected entangled pair states, Annals of Physics 349, 117 (2014) 
% \bibitem{NQS_Carleo}Giuseppe Carleo and Matthias Troyer, Solving the quantum many-body problem with artificial neural networks, Science 355, 602 (2017)
% \bibitem{Trebst}Peter Broecker, Juan Carrasquilla, Roger G. Melko, and Simon Trebst, Machine learning quantum phases of matter beyond the fermion sign problem, Sci. Rep. 7, 8823 (2017) 
% \bibitem{sign_generalization}Tom Westerhout, Nikita Astrakhantsev, Konstantin S.
% Tikhonov, Mikhail I. Katsnelson, and Andrey A. Bagrov, Generalization properties of neural network approximations to frustrated magnet ground states, Nat. Comm. 11, 1 (2020)
% \bibitem{castelnovo}Attila Szab\'o and Claudio Castelnovo, Neural network
% wave functions and the sign problem, Phys. Rev. Research 2, 033075 (2020)
% \bibitem{kastoryano}Chae-Yeun Park, Michael J. Kastoryano, Expressive power of complex-valued restricted Boltzmann machines for solving non-stoquastic Hamiltonians, Phys. Rev. B 106, 134437 (2022)
% \bibitem{Ceperley}David M. Ceperley, Fermion nodes, Journal of Stat. Phys. 63, 1237 (1991)
% \bibitem{fixed_node}Peter J. Reynolds and David M. Ceperley, Fixed‐node quantum Monte Carlo for molecules, J. Chem. Phys. 77, 5593 (1982)
% \bibitem{Ceperley_path}David M. Ceperley, Path-integral calculations of normal liquid ${}^3$He,
% Phys. Rev. Lett. 69, 331 (1992)
% \bibitem{spin_liquids}Wen-Jun Hu, Wei Zhu, Yi Zhang, Shoushu Gong, Federico Becca, and D. N. Sheng, Variational Monte Carlo study of a chiral spin liquid in the extended Heisenberg model on the kagome lattice, Phys. Rev. B 91, 041124(R) (2015)
% \bibitem{astrakhantsev2021}Nikita Astrakhantsev, Tom Westerhout, Apoorv Tiwari, Kenny Choo, Ao Chen, Mark H. Fischer, Giuseppe Carleo, and Titus Neupert, Broken-symmetry ground states of the Heisenberg model on the pyrochlore lattice, Phys. Rev. X 11, 041021 (2021)
% \bibitem{Imada_SC}Maxime Charlebois and Masatoshi Imada, Single-Particle Spectral Function formulated and calculated by variational Monte Carlo method with application to d-Wave superconducting state,
% Phys. Rev. X 10, 041023 (2020)
% \bibitem{strange_metals}Hong-Chen Jiang, Matthew S. Block, Ryan V. Mishmash, James R. Garrison, D. N. Sheng, Olexei I. Motrunich, and Matthew P. A. Fisher, Non-Fermi-liquid d-wave metal phase of strongly interacting electrons, Nature 493, 39 (2013)
% \bibitem{Slater_Jastrow_1}Robert Jastrow, Many-body problem with strong forces, Phys. Rev. 98, 1479 (1955)
% \bibitem{Slater_Jastrow_2}J. Toulouse and C. J. Umrigar, Optimization of quantum Monte Carlo wave functions by energy minimization, J. Chem. Phys. 126, 084102 (2007)
% \bibitem{Gutzwiller}Martin C. Gutzwiller, Effect of correlation on the ferromagnetism of transition metals, Phys. Rev. Lett. 10, 159 (1963)
% \bibitem{Nomura_fermions}Yusuke Nomura, Andrew S. Darmawan, Youhei Yamaji, and Masatoshi Imada, Restricted Boltzmann machine learning for solving strongly correlated quantum systems, Phys. Rev. B 96, 205152 (2017)
% \bibitem{neural_Gutzwiller}Francesco Ferrari, Federico Becca, and Juan Carrasquilla, Neural Gutzwiller-projected variational wave functions, Phys. Rev. B 100, 125131 (2019)
% \bibitem{NP_Troyer} Matthias Troyer and Uwe-Jens Wiese, Computational complexity and fundamental limitations to fermionic quantum Monte Carlo simulations, Phys. Rev. Lett. 94, 170201 (2005)
% \bibitem{Soluyanov} Mauro Iazzi, Alexey A. Soluyanov, and Matthias Troyer, Topological origin of the fermion sign problem, 
% Phys. Rev. B 93, 115102 (2016)
% \bibitem{nodal1} Lubos Mitas, Structure of Fermion Nodes and Nodal Cells, Phys. Rev. Lett. 96, 240402 (2006)
% \bibitem{nodal2} Michal Bajdich, Lubos Mitas, Gabriel Drobný, and Lucas K. Wagner, Approximate and exact nodes of fermionic wavefunctions: Coordinate transformations and topologies, Phys. Rev. B 72, 075131 (2005)
% \bibitem{sign_separating} Giacomo Torlai, Guglielmo Mazzola, Juan Carrasquilla, Matthias Troyer, Roger Melko, and Giuseppe Carleo, Neural-network quantum state tomography, Nature Physics 14, 447 (2018)
% \bibitem{glasses}S. Kobe and T. Klotz, Frustration: How it can be measured, Phys. Rev. E 52, 5660 (1995)
% \bibitem{CLRS} Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, and Clifford Stein, Introduction to algorithms, MIT press (2022)
% \bibitem{SA}Scott Kirkpatrick, C. Daniel Gelatt Jr, and Mario P. Vecchi, Optimization by simulated annealing, Science 220, 671 (1983) 
% \bibitem{Nikita_sign}Ao Chen, Kenny Choo, Nikita Astrakhantsev, and Titus Neupert, Neural network evolution strategy for solving quantum sign structures, Phys. Rev. Research 4, L022026 (2022)
% \bibitem{boothby2020next}Kelly Boothby, Paul Bunyk, Jack Raymond, and Aidan Roy, Next-generation topology of d-wave quantum processors, arXiv:2003.00133
% \bibitem{heim2015quantum}Bettina Heim,Troels F. R{\o}nnow, Sergei V. Isakov, and Matthias Troyer, Quantum versus classical annealing of Ising spin glasses, Science 348, 6231 (2015)
% \bibitem{kagome36}Pak Wo Leung, and Veit Elser, Numerical studies of a 36-site kagome antiferromagnet, Phys. Rev. B, {\bf 47}, 9, 5459 (1993)
% \bibitem{DMFT}Antoine Georges, Gabriel Kotliar, Werner Krauth, and Marcelo J. Rozenberg, Dynamical mean-field theory of strongly correlated fermion systems and the limit of infinite dimensions, Rev. Mod. Phys., 68, 13 (1996)
% \bibitem{QA}Philipp Hauke, Helmut G. Katzgraber, Wolfgang Lechner, Hidetoshi Nishimori, and William D. Oliver, Perspectives of quantum annealing: methods and implementations, Rep. Prog. Phys., 83, 054401 (2020)
% \bibitem{QA2} C. McGeoch and P. Farr\'e, The D-Wave Advantage system: an overview, Tech. Rep. (D-Wave Systems Inc, Burnaby, BC, Canada, 2020) D-Wave Technical Report Series 14-1049A-A
% \bibitem{QA3} D-Wave Systems, Technical description of the D-Wave quantum processing unit, Tech. Rep. (D-Wave Systems Inc., Burnaby, BC, Canada, 2020), D-Wave User Manual 09-1109A-V
% \bibitem{raymond2022hybrid}Jack Raymond, Radomir Stevanovic, William Bernoudy, Kelly Boothby, Catherine McGeoch, Andrew J. Berkley, Pau Farr{\'e}, and Andrew D. King, Hybrid quantum annealing for larger-than-QPU lattice-structured problems, ACM Transactions on Quantum Computing, 4, 308, 1--30 (2023)
% \bibitem{okada2019improving} Shuntaro Okada, Masayuki Ohzeki, Masayoshi Terabe, Shinichiro Taguchi, Improving solutions by embedding larger subproblems in a D-Wave quantum annealer, Scientific Reports 9, 2098 (2019)
% \bibitem{XY_model}John Michael Kosterlitz, The critical properties of the two-dimensional XY model, Journal of Physics C: Solid State Physics 7, 1046 (1974) 
% \bibitem{excited}Ken M. Nakanishi, Kosuke Mitarai, and Keisuke Fujii, Subspace-search variational quantum eigensolver for excited states, Phys. Rev. Research 1, 033062 (2019)
% \bibitem{TDVP}Jutho Haegeman, J. Ignacio Cirac, Tobias J. Osborne, Iztok Pižorn, Henri Verschelde, and Frank Verstraete, Time-Dependent Variational Principle for quantum lattices, Phys. Rev. Lett. 107, 070601 (2011)
% \bibitem{SpinED}\href{https://github.com/twesterhout/spin-ed}{https://github.com/twesterhout/spin-ed}
% \bibitem{zenodo-data}\href{https://zenodo.org/record/8221180}{https://zenodo.org/record/8221180}
% \bibitem{SA-code-1}\href{https://github.com/twesterhout/annealing-sign-problem}{https://github.com/twesterhout/annealing-sign-problem}
% \bibitem{zenodo-code}\href{https://zenodo.org/record/8221332}{https://zenodo.org/record/8221332}
% \bibitem{lattice-symmetries}Tom Westerhout, lattice-symmetries: A package for working with quantum many-body bases, Journal of Open Source Software, 6(64), 3537, \href{https://doi.org/10.21105/joss.03537}{https://doi.org/10.21105/joss.03537}, \href{https://github.com/twesterhout/lattice-symmetries}{https://github.com/twesterhout/lattice-symmetries}
% \bibitem{SA-code-2}\href{https://github.com/twesterhout/ising-glass-annealer}{https://github.com/twesterhout/ising-glass-annealer}
% \bibitem{SURF}\href{www.surf.nl}{www.surf.nl}
% \end{thebibliography}
